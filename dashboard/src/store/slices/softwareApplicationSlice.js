...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      AllApis.softwareApplicationRouter.getAllApplications.API,
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      AllApis.softwareApplicationRouter.addNewApplication.API,
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${AllApis.softwareApplicationRouter.deleteApplication.API}/${id}`,
      {
        withCredentials: true,
      }
    );
